...
function LessonPage() {
  ...
  const audioDemos = interaction?.audioDemos ?? []
    ...
    <div className="lab-page">
      ...
      <div className="lab-workspace">
        ...
        <section className="lab-canvas">
          ...
          {tab === 'circle' && <CircleOfFifthsPanel />}
        </section>
...
function TranscriptionPage() {
  ...
  return <div className="transcription-page"><div className="workbench-head"><div><span className="eyebrow"><WandSparkles /> 辅助扒谱工作台 · BPM 候选 + 手动标注 + 乐理分析</span><input className="project-title" value={fileName} onChange={(e) => setFileName(e.target.value)} aria-label="项目名称" /></div><div className="workbench-actions"><button className="button secondary compact" onClick={restore}><RotateCcw /> 打开上次</button><button className="button secondary compact" onClick={save}><Save /> 保存</button><button className="button primary compact" onClick={exportJson}>导出 JSON</button></div></div>
